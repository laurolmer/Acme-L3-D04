...
public class LecturerLectureListAllTest extends TestHarness {
	...
	public void test100Positive(final int recordIndex, final String title, final String abstractLecture, final String lectureLearningTime) {
		...
		super.checkColumnHasValue(recordIndex, 1, abstractLecture);
