...
public class StudentCourseListTest extends TestHarness {

	@ParameterizedTest
	@CsvFileSource(resources = "/student/course/list-positive.csv", encoding = "utf-8", numLinesToSkip = 1)
	void test100Positive(final int recordIndex, final String code, final String title, final String courseAbstract) {
